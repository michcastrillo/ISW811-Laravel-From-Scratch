...
En este nuevo módulo crearemos el diseño real del blog. Debemos descargar el proyecto en zip que esta en [Github](https://github.com/laracasts/Laravel-From-Scratch-HTML-CSS) y comenzar a migrarlo a nuestra aplicación Laravel. Como parte de esto, prepararemos el archivo de diseño y extraeremos algunos componentes de Blade.
...
2. En base al index.html del proyecto de Github vamos a editar el código de *resources/views/components/layout.blade.php* y solo dejaremos el *nav* y el *footer* para agregar el slot en medio de estos. 
    ...
    ```
3. Vamos a crear una vista post-card.blade.php en el directorio *resources/views/components*, usando elementos base al index.html del proyecto de Github vamos a editar el código.
    ```html
        <article
    ...
    ```
4. Vamos a crear la vista post-featured.blade.php en el directorio *resources/views/components* usando como base al index.html del proyecto de Github vamos a editar el código 
    ```html
        <article
            class="transition-colors duration-300 hover:bg-gray-100 border border-black border-opacity-0 hover:border-opacity-5 rounded-xl">
    ...
    ```
5. Vamos a crear una vista que contendrá el header del index.html del proyecto de Github llamada_post-header.blade.php en el directorio *resources/views* 
    ```html
    ...
    ```
5. En la vista posts.blade.php en el directorio *resources/views* solo vamos a dejar el siguiente código, en el cual llamamos las tres vistas creadas en el punto 3, 4, y 5. 
    ```html
        <x-layout>
